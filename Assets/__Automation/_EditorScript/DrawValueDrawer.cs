...
public class DrawValueDrawer : PropertyDrawer {
    ...
    // UnityEngine.Object selectedUniObject = null;
    // System.Object selectedSysObject = null;
    float propertyHeight = 0;
    // string prevSelectedField = "";
	public override void OnGUI( Rect position, SerializedProperty property, GUIContent label )
    {
        ...
        //Debug.Log(property.GetTargetObjectOfProperty(valueType));
        ...
        if(valueType != null)
        {
            try
            {
                ...
                // selectedFieldType = typeString.ToType();
        ...
        else
        {
            ...
            if (fieldInfo == null && propertyInfo == null)
            {
                ...
                if (splitString.Length > 1)
                {
                    ...
                    // if (splitString[1] == "GameObject") selectedFieldType = gm.GetType();
                    // else
                    // {
                    //     selectedFieldType = gm.GetComponent(splitString[1]).GetType();
                    // }
        ...
        // SelectedValue sysObj = (SelectedValue) property.GetTargetObjectOfProperty();
        // Debug.Log($"ValueType => {sysObj.valueType}");
    ...
    {
        //Debug.Log(property.GetTargetObjectOfProperty().GetType());
        ...
        //property.SetTargetObjectOfProperty(propertyName: "valueType", insideObject: true, value: selectedFieldType);

        //Debug.Log(selectedFieldType);
