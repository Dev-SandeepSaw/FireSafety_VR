...
public static class UnityEvent2Extension
{
    ...
    public static void Invoke(this UnityEvent2[] unityEvent2)
    {
        ...
        // if(!Application.isPlaying){ unityEvent2.SetVariable(); }
    ...
    public static void Invoke(this UnityEvent2 unityEvent2)
    {
        if(unityEvent2.unityObj != null)
        {
            ...
            //    #if UNITY_EDITOR
            //    if(returnValue != null) Debug.Log("Return Value => " + returnValue);
            //    #endif
            }else
            {
    ...
    private static void TriggerEvent(UnityEvent2 unityEvent2)
    {
        ...
        if(unityEvent2.selectedEventInfo != null)
        {
            ...
            // unityEvent2.selectedEventInfo.RaiseMethod.Invoke(unityEvent2.unityObj,null);

            // var delegateInstance = (Action)unityEvent2.selectedEventInfo.GetValue(test);
            // delegateInstance(); 

            // unityEvent2.selectedEventInfo.
            // Action eventAction = (Action)triggerEvent.gm.GetComponent(triggerEvent.selectEvent.Split('/')[0]).GetType().GetField(triggerEvent.selectEvent.Split('/')[1]);
            // unityEvent2[index].selectedEventInfo.RaiseMethod.Invoke(triggerFrom,null);
        }
    }
    private static void SetValue(UnityEvent2 unityEvent2)
    {
        Type firstValueType = null;
        // System.Object firstValue = null;
        ...
        // #if UNITY_EDITOR
        //     Debug.Log("FirstValueType => " + firstValueType + " | SecondValue => " + secondValue );
        // #endif

        // if(! typeof(UnityEngine.Object).IsAssignableFrom( firstValueType ) ){
        //     #if UNITY_EDITOR
        //         Debug.Log("First Value is UnityEngineObject");
        //     #endif
        // }
